...
spell_object.onMobSpawn = function(mob)
    ...
    mob:addSimpleGambit(ai.t.CASTER, ai.c.NOT_STATUS, tpz.effect.REFRESH, ai.r.MA, ai.s.HIGHEST, tpz.magic.spellFamily.REFRESH) -- TEST ADDNING REFRESH
    ...
    mob:addSimpleGambit(ai.t.TARGET, ai.c.NOT_STATUS, tpz.effect.SILENCE, ai.r.MA, ai.s.HIGHEST, tpz.magic.spellFamily.SILENCE, 60)
